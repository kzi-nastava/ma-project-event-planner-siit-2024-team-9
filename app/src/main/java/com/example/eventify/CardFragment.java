...
public class CardFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        servicesBinding = ActivityServicesBinding.inflate(getLayoutInflater());

        binding.detailsBtn.setOnClickListener(v -> {
            FragmentTransaction transaction = getParentFragmentManager().beginTransaction();
            transaction.replace(servicesBinding.fragmentContent.getId(), ServicesFormFragment.newInstance("gas","gas"));
